...
MAIN_PLOT = {
    ...
    (0, 1): {"model": "Flan-UL2-20B", "prompt": "A"},
    (1, 1): {"model": "Flan-UL2-20B", "prompt": "B"},
    (0, 2): {"model": "GPT-3", "prompt": "A"},
    (1, 2): {"model": "GPT-3", "prompt": "B"},
    (0, 3): {"model": "GPT-3.5 SFT", "prompt": "A"},
    (1, 3): {"model": "GPT-3.5 SFT", "prompt": "B"},
    (0, 4): {"model": "GPT-3.5 RLHF", "prompt": "A"},
    (1, 4): {"model": "GPT-3.5 RLHF", "prompt": "B"},
}
